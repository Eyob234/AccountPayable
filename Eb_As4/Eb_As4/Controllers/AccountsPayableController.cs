...
namespace accounts_payable.Controllers
{
    public class AccountsPayableController : Controller
    {
        ...
        public AccountsPayableController(APSect4Context apSect4Context)
        {
        ...
        public IActionResult AddEditVendor(string actionType, int groupNameFilterId, int vendorId = 0)
        {
            ...
            VendorAddEditViewModel vendorAddEditViewModel = new VendorAddEditViewModel()
            {
                Vendor = vendor,
            ...
            return View(vendorAddEditViewModel);
        }
        ...
        public IActionResult AddEditVendor(Vendor vendor, string actionName)
        {
            ...
            {
                ModelState.AddModelError("", "Ther is some errors in the form below.");
        ...
        public IActionResult VendorInvoiceList(int vendorId, int Invoiceid = 0)

        {
            ...
            VendorInvoiceList VIL = new VendorInvoiceList()
            {
                Vendor = vendorRecord,
